...
The Smart Hospital Command Center follows an autonomous multi-agent architecture where specialized AI agents collaborate to complete healthcare workflows.

## AI Agents

### 👤 Reception Agent
Handles the first interaction with patients.
...
### 🩺 Doctor Agent
Provides medical decision support.
